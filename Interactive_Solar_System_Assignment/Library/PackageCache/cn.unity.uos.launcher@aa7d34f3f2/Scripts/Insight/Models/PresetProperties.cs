...
namespace Unity.UOS.Insight.Models
{
    ...
    {
        /// <summary>
        /// Construct PresetProperties instance
        /// </summary>
        /// <param name="properties">preset properties</param>
        public PresetProperties(Dictionary<string, object> properties)
        {
            properties = EncodeDate(properties);
        ...
        private Dictionary<string, object> EncodeDate(Dictionary<string, object> properties)
        {
