...
namespace Unity.UOS.Auth
{
    ...
    public class AuthTokenManager : GenericSingleton<AuthTokenManager>
    {
        ...
        {
            SaveTokenWithoutReporting(uosAppID, token);
            InsightSDK.LoginByTokenInfo(token, "SaveToken");
        }


        // SaveToken 实际运作逻辑，剥离 Insight 上报部分代码
        public static void SaveTokenWithoutReporting(string uosAppID, TokenInfo token)
        {
        ...
        public static void SaveTokenWithoutReporting(TokenInfo token)
        {
            if (string.IsNullOrEmpty(Instance.CurrentUosAppID))
            {
                throw new AuthException(ErrorCode.NotInitialized, "AuthTokenManager未经初始化");
            ...
            SaveTokenWithoutReporting(Instance.CurrentUosAppID, token);
        }
        ...
        public static async Task<TokenInfo> ExternalLogin(ExternalLoginRequest request)
        {
            ...
            SaveTokenWithoutReporting(uosAppID, currentAppSetting.TokenInfo);
            InsightSDK.LoginByTokenInfo(currentAppSetting.TokenInfo, "ExternalLogin");
            return currentAppSetting.TokenInfo;
        }
        ...
        public static async Task GenerateAccessTokenWithUosAppId(string uosAppID, string userID, string userName = "")
        {
            ...
            SaveTokenWithoutReporting(uosAppID, currentAppSetting.TokenInfo);
            InsightSDK.LoginByTokenInfo(currentAppSetting.TokenInfo, "GenerateAccessToken");
        }
        ...
        public static async Task<TokenInfo> AsyncRefreshAccessToken(string uosAppID)
        {
            try
            {
                ...
                SaveTokenWithoutReporting(currentAppSetting.TokenInfo);
                return currentAppSetting.TokenInfo;
            }
            finally
            {
