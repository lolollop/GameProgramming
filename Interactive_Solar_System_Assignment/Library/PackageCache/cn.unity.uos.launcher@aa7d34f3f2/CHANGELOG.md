...
## [2.10.1] - 2026-04-16
### Fixed
- `login`事件上报时添加`login_function`信息

## [2.10.0] - 2026-04-01
### Added
- 添加PingServiceManager，提供multiverse相关延迟检测功能

## [2.9.2] - 2026-03-30
### Fixed
- 修复`AuthTokenManager.AsyncRefreshAccessToken`导致`login`事件冗余上报的问题

## [2.9.1] - 2026-03-26
### Fixed
- 修复Insight模块在小程序端的JSON序列化问题

## [2.9.0] - 2026-03-19
### Added
- 添加CdnDownloadUtils模块，支持直接获取CDN下载地址

## [2.8.5] - 2026-03-10
### Added
- Insight模块支持传入自定义事件触发时间及程序退出时回调
