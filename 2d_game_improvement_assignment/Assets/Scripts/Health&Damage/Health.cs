...
public class Health : MonoBehaviour
{
    ...
    [Tooltip("Color flash used when this object takes damage.")]
    public Color damageFlashColor = Color.red;
    [Tooltip("How long the damage color flash lasts.")]
    ...
    private float damageFlashEndTime = -1f;
    ...
    private void InvincibilityCheck()
    {
        ...
        if (spriteRenderer != null && damageFlashEndTime > 0f && Time.time >= damageFlashEndTime)
        {
            spriteRenderer.color = originalColor;
            damageFlashEndTime = -1f;
        }
    }
